...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        """
        was_published_recently() returns False for questions whose pub_date is older than one days
        """
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_published_recently() returns True for questions whose pub_date was within the last days
        """
...
class QuestionIndexViewTests(TestCase):
    def test_no_questions(self):
        """
        If no questions exist, and approriate message is displayed
        """
    ...
    def test_two_past_quesions(self):
        """
        The questions index may display multiple question
        """
